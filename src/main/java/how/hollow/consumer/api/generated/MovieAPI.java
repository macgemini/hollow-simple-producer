...
public class MovieAPI extends HollowAPI {
    ...
    public MovieAPI(HollowDataAccess dataAccess, Set<String> cachedTypes, Map<String, HollowFactory<?>> factoryOverrides, MovieAPI previousCycleAPI) {
        ...
        objectCreationSampler = new HollowObjectCreationSampler("String","Favorite","SetOfActor","AlreadyApplied");
        ...
        typeDataAccess = dataAccess.getTypeDataAccess("Favorite");
        if(typeDataAccess != null) {
            actorTypeAPI = new ActorTypeAPI(this, (HollowObjectTypeDataAccess)typeDataAccess);
        } else {
            actorTypeAPI = new ActorTypeAPI(this, new HollowObjectMissingDataAccess(dataAccess, "Favorite"));
        }
        addTypeAPI(actorTypeAPI);
        factory = factoryOverrides.get("Favorite");
        if(factory == null)
            factory = new ActorHollowFactory();
        if(cachedTypes.contains("Favorite")) {
            HollowObjectCacheProvider previousCacheProvider = null;
        ...
        if(typeDataAccess != null) {
            ...
            movieTypeAPI = new MovieTypeAPI(this, new HollowObjectMissingDataAccess(dataAccess, "AlreadyApplied"));
        }
    ...
    public Collection<Actor> getAllActor() {
        return new AllHollowRecordCollection<Actor>(getDataAccess().getTypeDataAccess("Favorite").getTypeState()) {
    ...
    public Collection<Movie> getAllMovie() {
        return new AllHollowRecordCollection<Movie>(getDataAccess().getTypeDataAccess("AlreadyApplied").getTypeState()) {
